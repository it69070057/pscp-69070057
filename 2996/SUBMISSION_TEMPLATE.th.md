...
```text
input = ข้อความภาษาอังกฤษ5ตัวอักษรที่รับเข้ามา โดยใช้ตัวแปรด้วยคำว่าletter
และ โจทย์ต้องการให้ตัวหนังสือออกมาแบบกลับหลังและเป็นพิมพ์เล็ก เลยกำหนดให้back เป็นตัวแปรที่ทำให้ตัวหนังสือกลับดด้านและแปลงเป็นพิมพ์เล็ก โดยใช้[::1](เริ่มจากตัวสุดท้ายไปจนถึงตัวแรกโดยขยับทีละ-1(การย้อนกลับ))และ.lower() สุดท้ายคือprint(back)
```
...
```text
Step 1:รับinputเข้ามา โดยใช้ตัวแปรletter
Step 2:แปลงinputให้ตัวหนังสือกลับหลังและทำเป็นตัวพิมพ์เล็ก โดยใช้ตัวแปร back = letter[::-1].lower()
Step 3:print(back)
```
...
```text
เหมือนกันกับวิธีแรกเพราะผ่านทุกtestcases
```
...
```text
มีตัวอักษร5ตัวตามที่โจทย์กำหนด และลองใส่ตัวพิมพ์ใหญ่1ตัวเพื่อดูว่าจะแปลงเป็นพิมพ์เล็กได้ไหม
```
...
```text
ทดสอบการแปลงตัวอักษรเป็นพิมพ์เล็ก
```
...
```text
ลองกลับหลังข้อความที่กลับหลังอีกที
```
...
```text
เพื่อนคู่pairในแลปPSCP
```

เขาช่วยอะไร

```text
ช่วยบอกว่าต้องใส่.lower()ด้วยเพื่อแปลงเป็ฯพิมพ์เล็กเพราะตอนแรกลืมใส่
```

คุณยังทำอะไรด้วยตนเอง

```text
คิดinput และ back = letter[::-1]
```
