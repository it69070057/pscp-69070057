...
```text
โจทย์ต้องการรับ ต้นทาง ปลายทาง และ น้ำหนักพัสดุ แล้วเอามาคำนวณค่าส่ง

input
บรรทัดแรก รับ ต้นทางกับปลายทาง
บรรทัดที่ 2 น้ำหนักพัสดุ

output
ถ้ามีเส้นทางจะขึ้นค่าส่ง
ถ้าไม่มีจะขึ้นError

สูตรค่าส่ง = ค่าธรรมเนียมเริ่มต้น + (ค่าส่ง/กก * น้ำหนัก)
