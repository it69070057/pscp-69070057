...
```text
input = เดือน , วันที่
โดยใช้เงื่อนไขว่า ถ้าเดือน <= 3 จะเป็นฤดูหนาว ถ้าเดือน <= 6 จะเป็นฤดูใบไม้ผลิ ถ้าเดือน <= 9 จะเป็นฤดูร้อน และถ้าเดือนอยู่นอกจากเงื่อนไขเหล่าี้จะเป็นฤดูใบไม้ร่วง
```
...
```text
Step 1:รับinput เป็นint ให้ตัวแปรเป็น month  , date 
Step 2:ใส่เงื่อนไขทั้งหมดที่โจทย์ฬห้มา
Step 3:ปริ้นoutputฤดูออกมา
```
...
```text
ทดสอบว่าถ้าเดือนอยู่ในฤดูหนึ่ง แต่เป็นหลังวันที่21 จะเปลี่ยนมาเป็นอีกฤดูมั้ย
```
...
```text
ลองใ่เดือนที่มากกว่า 9 เพรพาะจะทดสอบเงื่อไข else
```
