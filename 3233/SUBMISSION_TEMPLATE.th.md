...
```text
โจทย์ให้รับ เลขรางวับที่ออก และ เบขลอตเตอรี่ของเรา แล้วเช็กว่า
ตัวอักษรตรงไหม
เลข 5 หลักตรงไหม
เลข3ตัว และเลข2 ตัว ตรงไหม
```
...
"""lottery prize"""
    ...
    my_letter , my_letter = input().split()
รับค่า
win_letter = ตึัวอักษรรางวัลที่ออก
win_num = เลขรางวัลที่ออก
my_letter = ตัวอักษรที่ซื้อ
my_letter = ตัวเลขที่ซื้อ

Step 2:
    if win_letter == my_letter and win_num == my_num:
        prize = 1000000
    elif win_num == my_num:
        prize = 100000
    elif win_letter == my_letter and win_num[2:] == my_num[2:]:
        prize = 2000
    elif win_letter == my_letter and win_num[3:] == my_num[3:]:
        prize = 1000
        ...
        prize = 0
เช็คแต่ละเงื่อนไขตามโจทย์โดยเรียงจากมากไปน้อ



Step 3: 
print(prize) แสดงผลรางวัลออกมา
```
...
```text
ทดสอบกรณีที่ตรงทั้งตัวอักษรและเลข 5หลกั
```
...
```text
เช็กกรณีี่ตัวอักษรตรง และ เลขท้าย3ตัวตรงกัน
```
...
```text
ทดสอบกรณีที่ตัวอักษรไม่ตรง เลขท้ายตรง3 ตัว
```
