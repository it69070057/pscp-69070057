...
```text
โจทย์บอกว่า กบกำลังกระโดดไปข้างหน้่า โดยครั้งแรกกระโดดได้ x เมตร ครั้งต่อไป ระยะกระโดดจะลดลง 2 เมตรทุกครั้ง กบจะโดดต่อไปเรื่อยๆ จนกว่า ระยะทางรวมจะถึงหรือเกิน Y
แล้วให้หาว่า กบกระโดดอย่างน้อยกี่ครั้ง

ถ้่ระยะทางโดดลดลงจน ไม่สามารถกระโดดต่อได้ แล้วถ้ายังไปไม่ถึง Y ให้ตอบ -1
...
จากนั้นสร้างตัวแปรเริ่มต้น
total = 0
jumps = 0 
distance = x


Step 2:  วนลูป ตามระยะทางที่ยังกระโดดได้
while distance > 0:
เพิ่มระยะทางที่กระโดดเข้าไปใน total
total += distance
jump += 1
...
Step 3: 
ถ้ากระโดดแล้วยังไม่ถึง ให้print(-1)  จะทำงานเมื่อออกจากwhile  แต่ยังไม่ถึง Y แปลว่าไปไม่ถึง
```
...
```text
ทดสอบกรณีที่ระยะทางระยะรวม ถึงเป้าหมายพอดี
```
...
```text
ทดสอบกรณีที่กระโดด ครั้งเดียวถึงเป้าหมาย
```
...
```text
ทดสอบกรณีที่เป้าหมายอยู่ไกลมากจนไม่มีทางถึง แม้จะกระโดดจนหมดระยะแล้ว
```
