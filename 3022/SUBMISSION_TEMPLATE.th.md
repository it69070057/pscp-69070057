...
```text
input = temp = ค่าอุณหภูมิ , unit1 = หน่วยอุณหภูมิตแรก , unit2  = หน่วยอุณหภูมิที่ต้องการเปลี่ยน

คำนวณอุณภูมิแต่ละหน่วยในหน่วยแรกที่มาก่อนโดยแปลงกลับเป็นองศาเซลเซียส เมื่อจบเงื่อนไขนี้ temp จะกลายเป็นหน่วย องศาเซลเซียสทันที และเราก็จะนำมาทำเงื่อนไขต่อไปโยใช้สูตรจากโจทย์ และปริ้น output = (f{"temp:.2f"})
```
...
```text
ทำตามวิธีคิดแรก อาจจะมีการปรับสูตรตอนแปลงเป็นองศาเซลเซียสยนิดหน่อยเพราะงงตอนย้ายข้างตัวแปรทำให้สูตรผิด
```
...
```text
เช็คคำตอบว่าออกมาถูกตามที่คำนวณได้ไหม
```
