...
```text
input = ตัวเลขที่รับค่าเข้ามา
ใช้ for loop range(n , -1 , 1)คือเริ่มที่n จบก่อน -1 ลดลงครั้งละ1  if not i % 10 คือหารเอาเศษ ถ้าหารมาแล้วมีเศษจะไม่เอา ปริ้น i และมีช่องว่างด้วย end = " "
```
...
```text
Step 1:รับinput เป็นint ให้ตัวแปรเป็น n ค่าเริ่มต้นในการหาร 
Step 2:ใส่เงื่อนไขในการตรวจว่าถ้า i % 10 = 0 = TRUE
Step 3:ปริ้นi
```
...
```text
ทดสอบว่าได้เลขที่หาร10ลงตัวครบทุกตัวมั้ย
```
